...
treeAddressList.column('c2', width=40, ancher='center')
treeAddressList.column('c3', width=40, ancher='center')
treeAddressList.column('c4', width=120, ancher='center')
treeAddressList.column('c5', width=100, ancher='center')
treeAddressList.column('c6', width=90, ancher='center')
...
def buttonAddClick():
    ...
    # 所有输入都通过检查，插入数据库
    #sql = 'INSERT INTO addressList(***********************) VALUES("
#***********************")'
    doSql(sql)
